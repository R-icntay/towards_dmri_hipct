#!/usr/bin/env python
"""Probabilistic and deterministic fiber tractography from SH coefficients.

Loads spherical harmonic (SH) coefficient volumes produced by
03_fodf_estimation.py, constructs stopping criteria from GFA and
white-matter masks, generates seed points, runs DIPY tractography in
seed-chunks, and saves raw streamlines as .npy.
"""
...
if __name__ == "__main__":
    ...
    # ---- Save raw streamlines ----
    fname = ODF_ANALYSIS_DIR / f"raw_{tracking_type}_streamlines_{START_IDX}_{END_IDX}_{GFA_THRESHOLD}_{n_total:.4e}.npy"
