#!/usr/bin/env python
"""Fiber ODF estimation from structure tensor eigenvectors.
...
if __name__ == "__main__":
    ...
    group_size = VOXEL_RATIO_SCALE * voxel_ratio
    ...
    shc_zarr_path = odf_analysis_dir / f"sh_coefficients_degree_{DEGREE}_xyz.zarr"
